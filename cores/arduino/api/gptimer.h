 ...
 * Name of Author                    : Suneeth D, Shri Mahaalakshmi S J,Deeptha G 
 * Email ID                          : suneethdamodharan@gmail.com, mahaalakshmi@mindgrovetech.in,deeptha@mindgrovetech.in
 * 
 * @file gptimer.h
 * @author Suneeth D (suneethdamodharan@gmail.com)
 * @author Shri Mahaalakshmi S J (mahaalakshmi@mindgrovetech.in)
 * @author Deeptha G (deeptha@mindgrovetech.in)
...
/**
 * @fn GPT_Set_Period(GPTIMER_Config_t *gptimer)
 * 
...
/**
 * @fn GPT_Set_Dutycycle(GPTIMER_Config_t *gptimer)
 * 
...
/**
 * @fn  GPT_Set_Prescalar(GPTIMER_Config_t *gptimer)
 * 
...
/**
 * @fn void handle_gptimer_interrupt_for_delay()
 * @brief It is ISR routine for GPT_Delay_Milliseconds,GPT_Delay_Microseconds,GPT_Delay_Millisecs_H and GPT_Delay_Microsecs_H function.
 * @details The function is the ISR routine which is executed when the overflow interrupt of GPTIMER0 
 *        used for producing delay is generated. When the interrupt is generated, the global variable
 *        delay_done is made 0 to end the infinte loop in the delay function.
 *
 */
